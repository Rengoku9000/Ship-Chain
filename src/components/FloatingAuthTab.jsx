...
const GoogleSVG = () => (
    <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path fill="#e2e8f0" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
        ...
        <path fill="#94a3b8" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                style={{
                    opacity: 1 - (animationProgress * 1.2),
                    pointerEvents: isAuthenticating ? 'none' : 'auto'
                }}
                className={`fixed inset-0 bg-slate-900/${isAuthenticating ? '60' : '30'} backdrop-blur-md z-50 flex items-center justify-center p-4 transition-colors duration-[1500ms]`}
            >
                        ...
                        >
                            <div className="overflow-hidden bg-slate-900/40 backdrop-blur-xl border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.6)] rounded-2xl p-10 flex flex-col items-center">
                                <div className="mb-10 text-center space-y-1.5 w-full relative">
                                    ...
                                    <h2 className="text-2xl font-light tracking-wider text-slate-100">
                                        Access Gateway
                                    </h2>
                                ...
                                <AnimatePresence mode="wait">
                                    {authMode === 'google' && (
                                        ...
                                        >
                                            ...
                                            >
                                                <GoogleSVG />
                                                <span className="tracking-wider text-sm font-light">Continue with Google</span>
                                            </button>

                                            <div className="flex items-center w-full my-7 opacity-30">
                                                <div className="flex-1 h-px bg-slate-100"></div>
                                                <div className="px-4 text-[10px] uppercase tracking-[0.2em] text-slate-100 font-light">or</div>
                                                <div className="flex-1 h-px bg-slate-100"></div>
                                            </div>
                                    ...
                                    {authMode === 'email' && (
                                        ...
                                        >
                                            ...
                                            <button type="submit" className="w-full mt-4 flex items-center justify-center bg-slate-200 hover:bg-white text-slate-900 font-medium py-3 rounded-lg hover:-translate-y-[1px] active:scale-[0.98] transition-all duration-300 shadow-sm group">
                                    ...
                                    {authMode === 'signup' && (
                                        ...
                                        >
                                            ...
                                            <button type="submit" className="w-full mt-4 flex items-center justify-center bg-slate-200 hover:bg-white text-slate-900 font-medium py-3 rounded-lg hover:-translate-y-[1px] active:scale-[0.98] transition-all duration-300 shadow-sm group">
                                                <span className="tracking-wider text-sm">Create Account</span>
                                                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                                            </button>
                                        </motion.form>
                                    )}
                        ...
                        >
                            <motion.div animate={{ scale: [1, 0.98, 1] }} transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }}>
                                <motion.p
                                    ...
                                    className="text-slate-300 font-light tracking-[0.2em] uppercase text-xs mb-4"
                                >
