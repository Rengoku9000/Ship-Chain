...
const HeaderSystem = React.memo(({ simulationMode, onToggle }) => {
        ...
        <div className="flex items-center justify-between w-full h-full bg-[#0b1f2a]/60 backdrop-blur-md border border-white/10 rounded-xl px-6">
            <div>
                ...
                <div className="flex items-center space-x-4 mt-1">
                    <div className="flex items-center space-x-1.5 opacity-80">
                        ...
                        <span className="text-[9px] text-slate-400 uppercase tracking-widest">Network Online</span>
                    </div>
                    <div className="flex items-center space-x-1.5 opacity-80">
                        <Database className="w-3 h-3 text-blue-400" />
                        <span className="text-[9px] text-slate-400 uppercase tracking-widest">Core Active</span>
                    </div>
                    <div className="flex items-center space-x-1.5 opacity-80">
                        <Activity className="w-3 h-3 text-amber-400" />
                        <span className="text-[9px] text-slate-400 uppercase tracking-widest">{simulationMode ? 'Simulating' : 'Live Data'}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-end">
                ...
                <div className="flex items-center space-x-3 mt-1">
                    ...
                    >
                        {simulationMode ? 'SIM MUX: ON' : 'SIM MUX: OFF'}
                    </button>
                </div>
            </div>
        </div>
