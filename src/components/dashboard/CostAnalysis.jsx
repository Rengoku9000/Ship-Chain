        ...
        <div className="bg-[#0b1f2a]/60 backdrop-blur-md border border-white/10 rounded-xl p-5 shadow-2xl flex flex-col justify-between h-[160px]">
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center text-xs font-mono">
                    <span className="text-slate-400">Projected Burn Rate</span>
                    <span className="text-slate-200">$42,500 / hr</span>
                </div>
                <div className="flex justify-between items-center text-xs font-mono">
                    <span className="text-slate-400">Delay Penalties</span>
                    <span className="text-amber-400">$8,500</span>
                </div>
                <div className="flex justify-between items-center text-xs font-mono border-t border-white/5 pt-2">
                    <span className="text-blue-300">AI Optimization Savings</span>
                    <span className="text-blue-300">-$12,400</span>
                </div>
            </div>
        </div>
    );
